...
void do_curse(CHAR_DATA *ch, char *argument)
{
	...
	send_to_char("  align: Chaos's favor          20 gold\n\r",ch);
	send_to_char("  sanctuary: Chaos's protection 35 gold\n\r",ch);
    ...
    {
	act("$N says '{aChaos does not protect the pure of heart!{x'",
	    ch,NULL,mob,TO_CHAR);
	return;
    }
	...
	send_to_char("You feel Gaia's anger toward your actions!\n\r",ch);
	return;
     }
