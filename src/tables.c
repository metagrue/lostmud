...
{
	{	"[{oOOC{x]",    		"x",	"o",	COMM_NOOOC			},
	{	"[{HGOSSIP{x]",			"x",	"H",	COMM_NOGOSSIP		},
	{	"[{QQUOTE{x]",			"x",	"Q",	COMM_NOQUOTE		},
	{	"[{NMUSIC{x]",			"x",	"N",	COMM_NOMUSIC		},
	{	"[{PQA{x]",				"x",	"P",	COMM_NOASK			},
	{	"[{AAUCTION{x]",		"x",	"A",	COMM_NOAUCTION		},
	{	"[{JGRATS{x]",			"x",	"J",	COMM_NOGRATS		},
	{	"[{LIMM{x]",			"x",	"L",	COMM_NOWIZ			},
	{	"[{FCLAN{x]",			"x",	"F",	COMM_NOCLAN			},
	{	"[{EWAR{x]",			"x",	"E",	COMM_NOCGOSSIP		},
	{	"[{lQUEST{x]",			"x",	"l",	COMM_NOQGOSSIP		},
	{	NULL,					"",		"",		0				}
};
