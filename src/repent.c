...
void do_repent(CHAR_DATA *ch, char *argument)
{
	...
	send_to_char("  align: Gaia's forgiveness     20 gold\n\r",ch);
	send_to_char("  bless: Gaia's blessing        20 gold\n\r",ch);
	send_to_char("  sanctuary: Gaia's protection  35 gold\n\r",ch);
    ...
    {
	act("$N says '{aGaia does not protect the evil at heart!{x'",
	    ch,NULL,mob,TO_CHAR);
	return;
    }
	...
	send_to_char("You feel Chaos's anger toward your actions!\n\r",ch);
	return;
     }
